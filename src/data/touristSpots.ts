...
export const touristSpots: TouristSpot[] = [
  {
    ...
    description: "A stunning natural park featuring emerald-green waters flowing through towering limestone walls. This 2,018-hectare protected landscape offers breathtaking views and a refreshing escape into nature. The park's Sierra Madre limestone formations create a dramatic backdrop for swimming and kayaking adventures.",
  ...
  },
  {
    ...
    services: ["Cottage Rental", "Swimming Area", "Parking", "Restrooms"],
  ...
  },
  {
    ...
    activities: ["Art Workshops", "Gallery Tours", "Shopping", "Cultural Learning", "Photography"],
    location: {
      lat: 15.5234,
      lng: 120.8567,
      address: "Cabanatuan City, Nueva Ecija",
  ...
  },
  {
    ...
    services: ["Cottage Rental", "Food Vendors", "Parking", "Restrooms"],
    activities: ["Swimming", "Picnicking", "River Activities", "Relaxation", "Photography"],
    location: {
      lat: 15.4789,
      lng: 120.9567,
  ...
  },
  {
    ...
    services: ["Farm Tours", "Restaurant", "Boat Rental", "Fishing Equipment Rental"],
    activities: ["Fishing", "Boat Riding", "Farm Tours", "Dining", "Nature Walks"],
    location: {
      lat: 15.5123,
      lng: 120.8789,
      address: "Cabanatuan City, Nueva Ecija",
  ...
  },
  {
    ...
    services: ["Entrance Fee", "Basic Facilities", "Parking"],
    activities: ["Swimming", "Photography", "Trekking", "Picnicking", "Nature Appreciation"],
    location: {
      lat: 15.4956,
      lng: 121.0456,
      address: "General Tinio, Nueva Ecija",
  ...
  },
  {
    ...
    services: ["Farm Tours", "Farm Shop", "Dining Area", "Educational Programs"],
    activities: ["Farm Tours", "Harvesting", "Farm-to-Table Dining", "Educational Activities", "Shopping"],
    location: {
      lat: 15.5345,
      lng: 120.8678,
      address: "Cabanatuan City, Nueva Ecija",
