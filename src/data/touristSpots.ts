...
export const touristSpots: TouristSpot[] = [
  ...
  },
  {
    ...
    description: "St. Nicholas of Tolentine Parish Cathedral (Cabanatuan Cathedral) The Cabanatuan Cathedral is one of the main landmarks of the city. Aside from being a place of worship, it is also a symbol of faith and history. The church’s old-school design and quiet atmosphere make it a heartfelt place for both supplication and meditation.",
  ...
  },
  {
    ...
    {
    id: 11,
    name: "Camp Pangatian Shrine / American Memorial",
    description: "Camp Pangatian Shrine is a landmark with a rich history that pays respect to the heroism and sacrifice of the soldiers of World War II. In the past, the site was a POW camp and today, the memorial place is standing there—quiet and peaceful. Going to the site is being reminded of the price of freedom and the bravery of those who fought for it. ",
    shortdescription: "Camp Pangatian Shrine is a historical site built to honor the bravery of World War II soldiers.", 
    services: ["Museum Displays", "Tour Guides", "Parking Area"],
    activities: ["Educational Tours", "Museum Visits"],
    location: {
      lat: 15.51028,
      lng: 121.04457,
      address: "Pangatian, Cabanatuan City, Nueva Ecija",
    },
    image: campParaiso,
  },
];
