...
export const touristSpots: TouristSpot[] = [
  ...
  },
  {
    ...
    location: {
      lat: 15.5603906,
      lng: 121.1523155,
      address: "Tanawan Road, Brgy. Tanawan (or nearest), Laur, Nueva Ecija, Philippines"
    },
    image: tanawanFall,
  },
  {
    id: 6,
    name: "Calabasa River",
    description: "Calabasa River is a haven for people who love rivers and would like to visit at a quiet time when the river is at its most serene and the water is clean and inviting. Both local residents and foreign guests can release their stress peacefully, enjoy canoeing, or simply take in the beauty of nature around them. It’s a river that helps everyone reconnect with the simple joys of life through bonding with nature.",
    shortdescription: "Calabasa River is a calm and clean river where people enjoy swimming and fishing. It's perfect for nature lovers.",
    services: ["Picnic Spots", "Food Vendors", "Parking", "Restrooms"],
    activities: ["Swimming", "Picnicking", "Photography", "Kayaking", "Fishing"],
    location: {
      lat: 15.5289,
      lng: 121.2747,
      address: "Dingalan–Gabaldon Road, Brgy. Calabasa, Gabaldon, Nueva Ecija, Philippines",
    },
    image: calabasaRiver,
  },
  {
    ...
    description: "Lake Farm de La Marre Agri-Tourism Park is a sustainable farm and leisure destination that blends relaxation, learning, and nature. It features scenic views of the lake, landscaped gardens, and vast farmlands—perfect for family outings and eco-friendly adventures. The park promotes sustainable agriculture and offers hands-on experiences that give visitors a taste of rural life in an enjoyable and educational way.",
    shortdescription: "An agri-tourism park by the lake offering farm activities, fishing, boat rides, and scenic relaxation.",
    ...
    location: {
      lat: 15.7960438,
      lng: 121.1776689,
      address: "Corner Pantabangan–Canili Road, Pantabangan, Nueva Ecija, Philippines",
    },
    image: lakeFarm,
  },
  {
  ...
  shortdescription: "Farm Villaronte is a peaceful farm where visitors can learn about planting and caring for animals.",
  ...
  location: {
    lat: 15.3018,
    lng: 120.9913,
    address: "9R5Q+JC2, Ilang-Ilang, Brgy. San Antonio, Nueva Ecija, Philippines"
  },
...
},
{
  ...
  location: {
    lat: 15.64428,
    lng: 121.26700,
    address: "Sitio Camp Martyr, Brgy. Labi, Bongabon, Nueva Ecija, Philippines"
  },
  image: campParaiso,
},
];
